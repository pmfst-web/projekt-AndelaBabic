...
import PopisKnjiga from './screens/PopisKnjiga'
import UneseneKnjige from './screens/UneseneKnjige'
...
function App() {
  ...
  const [knjigaKorisnika, postaviKnjigu] = useState()

  const pocetakUnosa = (knjiga) => {
    postaviKnjigu(knjiga)
  }

  let sadrzaj = <UnosEkran pocetak={pocetakUnosa}/>
  if (knjigaKorisnika){
    sadrzaj=<UneseneKnjige pocetak={pocetakUnosa}/>
  }
